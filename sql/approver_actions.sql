create or replace function sql2fa.approver_actions(req_request_id uuid, a_approver_id char(4), approver_decision sql2fa.status_codes, a_approver_notes text default ' ')
returns void
language plpgsql
security definer as $$
/*Variables*/
