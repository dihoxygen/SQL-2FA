...
begin
    ...
    set current_status = requestor_action
    ...
    --LOG CANCELLATION
    insert into sql2fa."REQUEST_EVENTS" (request_id, event_seq, current_status, status_change_dt, old_sql_text, requestor_edit_notes, status_changed_by_operator_id)
