CREATE OR REPLACE FUNCTION sql2fa.edit_denied_request (
    req_request_id uuid,
...
BEGIN
    ...
    SET
        ...
        assigned_approver = (select status_changed_by_operator_id from sql2fa."REQUEST_EVENTS" where request_id = req_request_id and current_status = 'D' order by event_seq desc limit 1)
    WHERE
